      ...
      in
      {
        packages = {
          ...
          claude-code = pkgs.buildNpmPackage (claudeCodeBase // {
            npmDepsHash = "sha256-G2lvmJS7R2AEinXVb18QRIFc1o6iEX7604bvQkwdhOM=";
            ...
            installPhase = ''
              ...
              #!/usr/bin/env bash
              exec ${pkgs.nodejs_20}/bin/node --max-listeners=20 $out/lib/node_modules/@anthropic-ai/claude-code/cli.js "\$@"
              EOF
